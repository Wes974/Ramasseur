...
#define calDistance 10 //in inches 24inches or 2 foot
...
int calWidth = 86; //Calibrated width reading
int calHeight = 40; //Calibrated height reading
...
float widthOfObject = 4; //inches (3.75 inches) real size of your object
float heightOfObject = 2; //inches (2.5 inches) real size of your object
